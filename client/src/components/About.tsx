...
export default function About() {
  return (
    <section id="about" className="relative py-16 px-6 bg-[hsl(120,20%,15%)]" data-testid="section-about">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16 text-center">
          <h2 className="font-mono text-3xl md:text-4xl mb-4" data-testid="heading-about">
            <span className="text-primary">&lt;</span><span className="text-white">About</span><span className="text-primary">/&gt;</span>
          </h2>
        </div>
